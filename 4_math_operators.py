...
if a == 0: #Error check
    print("Error, a can't equal to zero")
else:
    discriminant = math.sqrt(float(b**2 - 4 * a * c)) #Equesion
...
if r <= 0 or h <= 0: #Error check
    ...
    print(f"Volume = {round(cone_volume, 2)} units\u00b3") #Output
...
if r <= 0: #Error check
    ...
    print(f"Volume = {round(sphere_volume, 2)} units\u00b3") #Output
...
if r <= 0 or h <= 0: #Error check
    ...
    print(f"Surface area = {round(cylinder_sa, 2)} units\u00b2") #Output
...
if b <= 0 or l <= 0:  # Error check
    ...
    print(f"Surface area = {round(prism_sa, 2)} units\u00b2")  # Output
